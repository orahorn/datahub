...
* [Языки и код](02-code.md): CNC, машинный, ассемблер, третий уровень (Pascal, Си, Go, ...) . Читалось: 30 сен. 2021 г. ; 01 окт. 2021 г. (от [C#](02-code.md#c---один-из-наследников-языков-cc)) ; Прочитано: 07 окт. 2021 г. от [Erlang/OTP](02-code.md#erlangotp)
	...
	- компоновка исполнимых модулей с библиотеками и объектными файлами
		...
		+ GNU BinUtils
* [Средства сборки программ](03-tools.md): Читалось: 08 окт. 2021 г. ; Прочитано: 14 окт. 2021 г. от [Интерактивной разработки](03-tools.md#интерактивная-разработка)
...
* [Безопасность](04-security.md) Прочитано: 15 окт. 2021 г.
	...
	- Методы безопасности
		...
		+ ЭЦП пакетов ОС
* [Тестирование](05-testing.md) Прочитано: 21 окт. 2021 г.
	- модульное (unit test)
...
* [Сети и телекоммуникации](10-networks.md) прочитано 28.10.2021
...
* [Производительность и распараллеливание](20-parallelization.md) прочитано 29.10.2021
...
* [Роль баз данных](30-databases.md) прочитано 10.11.2021
	- локальные СУБД
	...
	- распределённые СУБД больших данных (NoSQL)
		+ MongoDB
		+ Redis
* [Журналирование событий и ведение статистики работы ИУС](40-logstat.md) прочитано 12.11.2021
	...
	- системы ведения статистики
		+ sysstat, sar, ksar, ...
* [Окружение, параметры командной строки и конфигурационные файлы](50-env_cfg.md) **эта и последующие лекции не читались**
	- Чтение переменных окружения
	- Обработка параметров командной строки внутри программы
	- Форматы конфигурационных файлов и соотв. библиотеки
...
* Виртуализация и эмулирование: тестирование, наследуемые системы...
	- система виртуализации VirtualBox
	- многоплатформенный эмулятор QEMU
	- библиотечные трансляторы API: WINE и Cygwin
* Встраиваемые системы
	- аппаратура:
		+ микроконтроллеры (Arduino, AVR, ATmel...)
		+ микрокомпьютеры (BeagleBoard от TI, Raspberry Pi)
	- Особенности ОС:
		+ минимальное урезанное ядро
		+ оболочка и утилиты на базе [BusyBox](https://ru.wikipedia.org/wiki/BusyBox)
...
* Системы машинного обучения и искуственный интелллект (нейронные сети). Библиотеки:
	- OpenCV
	- FANN
* Системы документации проектов
	- doxygen
* Системы резервного копирования и архивирования
* [Замечания по кроссплатформенному программированию на Windows](90-winnotes.md)
* [Лабораторные работы](95-labs.md) по курсу
* [Экзаменационные вопросы по курсу](97-questions.md)
* Примерный список [курсовых заданий](99-tasks.md)
