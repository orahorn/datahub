...
* [Языки и код](02-code.md): CNC, машинный, ассемблер, третий уровень (Pascal, Си, Go, ...) . Прочитано: 30 сен. 2021 г. ; 01 окт. 2021 г. (от [C#](02-code.md#c---один-из-наследников-языков-cc)) ; Прочитано: 07 окт. 2021 г. от [Erlang/OTP](02-code.md#erlangotp)
	...
	- компоновка исполнимых модулей с библиотеками и объектными файлами
		...
		+ GNU BinUtils
* [Средства сборки программ](03-tools.md): Прочитано: 08 окт. 2021 г. ; Планируется 14 окт. 2021 г от [Интерактивной разработки](03-tools.md#интерактивная-разработка)
