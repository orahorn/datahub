...
Сигналы с GPIO не только зажигают лампы и светодиоды, но и переключают высковольтные реле, запускают двигатели и сервоприводы роботов.
...
## 01.04. Интерфейсы машина-машина
...
Во встраиваемой электроники используют интерфейс GPIO, который на контроллерах оформлен в виде обычной
...
сенсорные экраны и т.д. Есть не только промышленные, но и любительские (домашние) контроллеры и одноплатные компьютеры
соотв.:
...
В автопромышленности и станках ЧПУ сегодня используется интерфейс CAN.
