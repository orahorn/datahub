...
История появления информационной безопасности в рамках кода и дисциплин
работы с операционными системами (ОС) ведёт начало в 1970-е годы.
В первых системах не было разделения процессов и объектов файловой системы (ФС)
на принадлежности к каким-то пользователям, группам и др. субъектам.
Права на ограничения даже не использовались в последующие десятилетия в таких
системах, как DOS.
Однако по мере совершенствования функционала, вводились механизмы доступа такие как:

* регистрация пользователя под своим идентификатором и порождение всех процессов под ним
* фиксация аттрибутов доступа  ([прав](https://en.wikipedia.org/wiki/File-system_permissions)) в каталогах файловой системе

Первыми командами в популярных системах семейства Unix для этого были:

* [chown](https://ru.wikipedia.org/wiki/Chown) - назначались идентификаторы владельца и первичной группы на объект ФС
* [chmod](https://ru.wikipedia.org/wiki/Chmod) - регулировались права доступа этих субъектов:
	- чтение
	- запись
	- исполнение
* [chattr](https://en.wikipedia.org/wiki/Chattr) - более продвинутое расширение по управлению атрибутами файлов

[SELinux](https://ru.wikipedia.org/wiki/SELinux) - основное средство защиты и безопасности в околокорпоративных ОС Linux:

* [Fedora](https://ru.wikipedia.org/wiki/Fedora)
* [RHEL](https://ru.wikipedia.org/wiki/Red_Hat_Enterprise_Linux)
* [CentOS](https://ru.wikipedia.org/wiki/CentOS)
* [Alma](https://en.wikipedia.org/wiki/AlmaLinux)
* [Rocky](https://en.wikipedia.org/wiki/Rocky_Linux)
...
Подобные доступы связаны с понятием избирательного управления доступом (англ. discretionary access control,
[DAC](https://ru.wikipedia.org/wiki/%D0%98%D0%B7%D0%B1%D0%B8%D1%80%D0%B0%D1%82%D0%B5%D0%BB%D1%8C%D0%BD%D0%BE%D0%B5_%D1%83%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5_%D0%B4%D0%BE%D1%81%D1%82%D1%83%D0%BF%D0%BE%D0%BC)
). Это когда есть матрица доступа субъектов
